...
export const projects: Project[] = [
  ...
  },
  {
    ...
    challenge:
      "Creative label sites need a distinct visual identity while still making content easy to browse, understand, and expand over time.",
    solution: [
      "Built the structure around releases and label identity.",
      "Used a dark visual system to support the music brand.",
      "Created responsive layouts for desktop and mobile browsing.",
      "Balanced atmosphere with clarity so content remains easy to scan.",
    ],
    outcome:
    ...
    visuals: [
      {
        ...
        description: "A dark creative homepage built around the label brand.",
      },
      {
        title: "Mobile layout",
        image: "/images/projects/tinnie-house-mobile.webp",
        alt: "Tinnie House Records mobile website",
        description: "Responsive browsing for releases and label content.",
        imageClassName: "object-contain p-6 md:p-8",
      },
      {
        title: "Portfolio thumbnail",
